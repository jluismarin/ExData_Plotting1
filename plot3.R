## The script bellow writes to disk the plot3.png file which reconstructs ./figure/unnamed-chunk-4.png
...
##    (4) Writes plot for 3 measures of Energy sub metering vs DateTime in png graphic device
